...
public class Globals {
    ...
    public static String path_origin = "./src/mp4files/origin/";
    public static String path_destination = "./src/mp4files/destination/";
    ...
    public static String player_abs_filepath = "./src/mp4files/destination/";
    // WIN CONFIGS
